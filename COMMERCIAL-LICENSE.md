...
**Running your own instance triggers no obligation.** ob-sync is single-user by
...
You need a commercial licence if you want to **offer ob-sync to other people as
...
Everything about ob-sync's ordinary use — self-hosting, modifying it, deploying
...
Because ob-sync is dual-licensed, contributions need a Contributor Licence
...
whoever deploys ob-sync, not redistributed by this project. If you intend to
