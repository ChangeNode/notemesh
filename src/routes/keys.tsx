                ...
                {(d) => (
                    <>
                        <article>
                            ...
                            <p class="muted">
                                <b>If your MCP client supports OAuth, use that instead.</b> Claude Desktop, claude.ai,
                                Claude Code and Codex all run the OAuth flow — you approve access once in the
                            ...
                            <Show when={d.apiKeys.length > 0} fallback={<p class="muted">No API Keys Created</p>}>
                                <table>
                                    <thead>
                                    <tr>
                                        <th>Name</th>
                        ...
                        <article>
                            ...
                            <p>Send it on every request as either header:</p>
                            <Snippet text={"Authorization: Bearer <key>\nx-api-key: <key>"}/>
                            <p>…against this endpoint:</p>
