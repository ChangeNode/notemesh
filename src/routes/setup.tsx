                    ...
                    fallback={
                        <article>
                            ...
                            <p class="muted">
                                ...
                                <code>BASE_URL</code> variable
                                to <code>https://{c.originMismatch!.reachedAt}</code>{" "}
                                and redeploy.
                            </p>
                            <p class="muted">
            ...
            <form onSubmit={submit}>
                ...
                <div class="grid">
                    <div>
                        ...
                        <input id="git-branch" type="text" value={branch()}
                ...
                <small class="muted">
                    ...
                    answer. Two exceptions: a <b>deploy token</b> wants the username and token to match, and a
    ...
    return (
        <article>
            ...
            <form onSubmit={submit}>
                ...
                <input id="ob-password" type="password" required value={password()}
                       onInput={(e) => setPassword(e.currentTarget.value)}/>
                <label for="ob-mfa">
                ...
                />
                <small class="muted">
                    Leave blank if you don't use two-factor codes. Get it from your authenticator just before
                    submitting,
                    since the codes expire quickly.
                </small>
                <Show when={error()}>
                    <p class="error">{error()}</p>
                </Show>
                        ...
                        <Show
                            ...
                            fallback={
                                <>
                                    <Show when={l.message?.includes("sign in again")}>
                                        <div class="callout warn">
                                            <p>
                                                ...
                                                the most common cause is a password that wasn't accepted.
                                            </p>
                                            <p class="muted">
                                    ...
                                    <input id="vault-name" type="text" required value={vault()}
